...
class CharacterNetworkGenerator():
    ...
    def generate_character_network(self, df):
        ...
        relationship_df = relationship_df.sort_values('value', ascending=False)  # Sorted in descending order to ensure that more significant actors appear at the top and less significant actors appear at the bottom
